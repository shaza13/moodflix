...
class ResultPage(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        if Movie.query().count() == 0:
            shrek = Movie(title='Shrek', duration=123, rating=10, description='About an ogre who lives in a swamp.', mood='humorous, gloomy', occasion='family night')
            shrek_key = shrek.put()
            print("adding movies")
            ...
            moana = Movie(title='Moana', duration=107, rating=8, description="In Ancient Polynesia, when a terrible curse incurred by the Demigod Maui reaches Moana's island, she answers the Ocean's call to seek out the Demigod to set things right.", mood='cheerful, mellow, gloomy', occasion='family night, playdate, casual watching')
            moana_key = moana.put()
